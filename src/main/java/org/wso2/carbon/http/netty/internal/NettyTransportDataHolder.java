...
public class NettyTransportDataHolder {
    ...
    public void addChannelInitializer(CarbonNettyChannelInitializer initializer) {
        channelInitializers.add(initializer);
    }

    public List<CarbonNettyChannelInitializer> getChannelInitializers() {
        return Collections.unmodifiableList(channelInitializers);
    }

    public void removeChannelInitializer(CarbonNettyChannelInitializer initializer) {

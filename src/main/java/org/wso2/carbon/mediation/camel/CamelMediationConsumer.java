...
/*
    public void mediate(CarbonMessage msg) {

        Exchange exchange = getEndpoint().createExchange();

        //get headers from carbon message
        exchange.getIn().setHeaders(getCamelHeaders(msg, exchange));

        //get body from carbon message
        exchange.getIn().setBody("...Test Message Body...");
